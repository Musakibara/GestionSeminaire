                                ...
                                <tr>
                                    ...
                                    <td class="text-center" ><?php echo $Seminaire['supportCours'] ?> </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            &nbsp;
                                            <a href="newRapportFin?idSeminaire=<?php echo $Seminaire['idSeminaire'] ?>">
                                                <span class="bi bi-upload" style="color: var(--bs-info);"></span>
                                            </a>
                                            &nbsp;
                    ...
                    <ul class="pagination">
                        <?php for($i=1;$i<=$nbrPage;$i++){ ?>
                            <li class="<?php if($i==$page) echo 'active' ?>"> 
                                <a href="SeminaireSecret?page=<?php echo $i;?>&nomSemin=<?php echo $nomSemin ?>">
                                    <?php echo $i; ?>
                                </a> 
                             </li>
                        <?php } ?>
