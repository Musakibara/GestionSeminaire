        ...
        <div class="container">
            <div class="panel panel-success margetop60">
				...
				<div class="panel-body">
					...
					<form method="get" action="consultant.php" class="form-inline">
                                ...
                                <tr class="<?php echo $Consultant['etat']==1?'success':'danger'?>">
                                    ...
                                    <td class="text-center"><?php echo $Consultant['email'] ?> </td>
                                        ...
                                        <td class="text-center">
                                            <a href="editerForm?idConsultant=<?php echo $Consultant['idConsultant'] ?>">
                                                <span class="bi bi-pencil-square" style="color: var(--bs-success);"></span>
                                            </a>
                                            &nbsp;
                                            <a onclick="return confirm('Etes vous sur de vouloir supprimer le Consultant??')"
                                                href="deleteForm?idConsultant=<?php echo $Consultant['idConsultant'] ?>">
                                                    <span class="bi bi-trash3-fill" style="color: var(--bs-danger);"></span>
                                            </a>
                                            &nbsp;
                                            <a href="activerForm?idConsultant=<?php echo $Consultant['idConsultant'] ?>&etat=<?php echo $Consultant['etat']?>">  
                                                <?php  
                                                    if($Consultant['etat']==1)
            ...
            <a href="consultant?page=<?php echo $i;?>&denomination=<?php echo $denomination ?>&typeConsultant=<?php echo $typeConsult ?>">
                                    <?php echo $i; ?>
                                </a> 
                             </li>
                        <?php } ?>
