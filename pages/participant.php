...
<HTML>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                <th class="text-center">Id Participants</th><th class="text-center">Nom Participant</th><th class="text-center">Email Participant</th><th class="text-center">Numero telephonique</th><th class="text-center">Nom Structure</th><th class="text-center">Photo</th><th class="text-center">Actions</th>
                            </tr>
                        </thead>
                            ...
                            <?php while($Participant=$resultatP->fetch()){ ?>
                                <tr class="<?php echo $Participant['etat']==1?'success':'danger'?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <a href="editerParti?idParticipant=<?php echo $Participant['idParticipant'] ?>">
                                                <span class="bi bi-pencil-square" style="color: var(--bs-success);"></span>
                                            </a>
                                            &nbsp;&nbsp;
                                            <a onclick="return confirm('Etes vous sur de vouloir supprimer le Participant??')"href="deleteParti?idParticipant=<?php echo $Participant['idParticipant'] ?>">
                                                    <span class="bi bi-trash3-fill" style="color: var(--bs-danger);"></span>
                                            </a>
                                            &nbsp;&nbsp;
                                            <a href="activerParti?idParticipant=<?php echo $Participant['idParticipant'] ?>&etat=<?php echo $Participant['etat']?>">  
                                                <?php  
                                                    if($Participant['etat']==1)
                                                        echo '<span class="bi bi-person-x-fill" style="color: var(--bs-warning); font-size: 2rem;"></span>';
                                                    else 
                                                        echo '<span class="bi bi-person-check-fill" style="color: var(--bs-warning); font-size: 2rem;"></span>';
                                                ?>
                                            </a>
            ...
            <a href="Participant?page=<?php echo $i;?>&nomParti=<?php echo $nomParti ?>&nomStructure=<?php echo $nomStructure ?>">
                                    <?php echo $i; ?>
                                </a> 
                             </li>
                        <?php } ?>
