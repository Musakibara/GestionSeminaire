...
<html>
	...
	<body>
	<?php include("menuSecret.php"); ?>		
		<br><br><br><br>
		<div class="container col-md-4 col-md-offset-4">			
			<div class="panel panel-primary">
				<div class="panel-heading text-center">Upload Seminary Ripport</div>
					...
					if(isset($_GET['idSeminaire']))
					{
						...
						if($fetch_data->rowCount() > 0)
						{
							foreach($fetch_data as $row)
							{
								...
								<form method="post" action="uploadRapFin.php" class="form" enctype="multipart/form-data">
									<input type="hidden" class="form-control" name="idSeminaire" value="<?php echo $row['idSeminaire']?>">

									<div class="form-group">
										<label for="rapport" class="control-label">UPLOAD RAPPORT</label>
