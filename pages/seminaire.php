                                ...
                                <tr>
                                    ...
                                    <td class="text-center" ><?php echo $Seminaire['supportCours'] ?> </td>
                                        ...
                                        <td class="text-center">
                                            <a href="editerSemin?idSeminaire=<?php echo $Seminaire['idSeminaire'] ?>">
                                                <span class="bi bi-pencil-square" style="color: var(--bs-success);"></span>
                                            </a>
                                            &nbsp;
                                            <a onclick="return confirm('Etes vous sur de vouloir supprimer le ??')" href="deleteSemin?idSeminaire=<?php echo $Seminaire['idSeminaire'] ?>">
                    ...
                    <ul class="pagination">
                        <?php for($i=1;$i<=$nbrPage;$i++){ ?>
                            <li class="<?php if($i==$page) echo 'active' ?>"> 
                                <a href="Seminaire?page=<?php echo $i;?>&nomSemin=<?php echo $nomSemin ?>">
                                    <?php echo $i; ?>
                                </a> 
                             </li>
                        <?php } ?>
