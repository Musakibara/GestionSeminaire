...
<?php
    ...
    require('identifierForm.php');
    require_once('../fonctions/fonctionForm.php');

    $requete=$conn->prepare("SELECT * FROM Consultant");
    $requete->execute();
...
<head>
    <meta charset="utf-8"/>
    <title> Consultant_Dashboard</title>
...
<?php include('../pages/menuForm.php'); ?>
<br><br><br><br>
<div class="container  tableau-stat text-center">
    <h1 class="text-center text-primary"><i>STATISTIQUES DE BASE POUR  <b><?php echo ' '. $_SESSION['denomination'] ?></b></i></h1>
    <br><br>
    <div class="row">
